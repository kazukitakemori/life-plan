...
const WORK_DESIGN_HELP_ITEMS: Record<'detail' | 'simple', string[]> = {
  ...
  detail: [
    ...
    '2028年4月以降の死亡分割は、死亡者との婚姻・内縁関係が始まった時期を保存していないため、将来の老齢厚生年金へ自動反映しません。',
    '2028年4月以降の子の遺族基礎年金は現在登録されている家族関係で試算します。死別後の再婚・養子縁組・引取りなど将来の家族関係の変化は予測しません。',

    '2028年4月以降の死亡分割は、婚姻期間中の厚生年金記録だけを対象とします。現在は婚姻開始時期を保存していないため、残された配偶者の将来の老齢厚生年金へ死亡分割分を自動加算していません。',
