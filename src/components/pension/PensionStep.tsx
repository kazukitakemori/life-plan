  ...
  return (
    <div className="step-page pension-step">
      ...
      {hasCurrentDisabilityPension ? (
        <p className="purpose-input-note" role="note">
          Q1で障害年金の受給権が登録されています。障害年金額は自動計算対象外のため、現時点ではQ8・キャッシュフローへ金額を自動反映していません。また、障害年金の全額支給停止、受給開始・失権年月、65歳以降の年金選択は保存していないため、加給年金・振替加算・経過的寡婦加算などとの調整や、65歳前に受給権を失った場合の繰下げ可否までは完全に自動判定できません。現在登録されている受給権が続く前提で、確認できる範囲だけを反映します。
        </p>
      ) : null}
