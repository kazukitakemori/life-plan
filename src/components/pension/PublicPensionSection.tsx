    ...
    <section className="pension-section">
      ...
      <div className="pension-subsection">
        ...
        <div className="pension-enrollment-panel">
          ...
          {pastEnrollment === 'none' && (
            <div className="pension-source-info-row">
              <span>Q7「収入」の内容から加入状況を推定して試算します。</span>
              <InfoDialog title="収入情報から概算する場合" label="概算の前提">
                <p>
                  ねんきん定期便が手元になくても、Q7「収入」の内容をもとに、これまでと今後の加入状況を推定して老齢年金額を試算できます。
                </p>
                <p>
